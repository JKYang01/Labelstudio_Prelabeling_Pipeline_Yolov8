...
from pipeline_utils.utils import (DEFAULT_CFG,label_save,DEVICE)
from pipeline_utils.utils.s3_load import img_from_s3,download_model
...
def base_detect(overrides=None,**kwargs):
    ...
    save_piece=kwargs.get('save_piece', False)
    if detect_image_url:
...
def medium_detect(**kwargs): 
        ...
        local_path = f"{temp_dir}/model.pt"
        download_model(model_path=model_path, local_path=local_path)

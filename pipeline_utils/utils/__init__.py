...
ROOT = FILE.parents[1]
DEFAULT_CFG_PATH = ROOT / 'cfg/detect_config.yaml'
CLASS_FILE = ROOT/ 'cfg/shape_classes.txt'


with open(CLASS_FILE, 'r') as file:
    CLASSES = [x.rstrip('\n') for x in file.readlines()]

## set up paralell processing depending on GUP numbers
...
if gpu_count<1:
    ...
    DEVICE = [str(num) for num in range(gpu_count)]
    ppl=True
